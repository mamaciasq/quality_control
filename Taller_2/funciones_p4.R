############################################################################################
# C?LCULO DE LOS L?MITES DE CONTROL EN LAS CARTAS X BARRA, CUSUM Y EWMA PARA UN ARL0
...
############################################################################################
# C?LCULO DEL ARL1 EN LAS CARTAS X BARRA, CUSUM Y EWMA
